...
const Vichelpanel = ({ setvichelpanel, vichelpanelref }) => {
  ...
  return (
    <div>
        ...
        <div className="border-2 active:border-black border-gray-200 flex items-center rounded-2xl justify-between p-0.5 gap-4">
        ...
        <div className="border-2  active:border-black border-gray-300 flex items-center rounded-2xl justify-between p-0.5 gap-4 mt-3">
